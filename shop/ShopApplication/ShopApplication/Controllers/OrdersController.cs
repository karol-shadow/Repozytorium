...
namespace ShopApplication.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var shopDatabaseContext = _context.Orders
                .Include(o => o.Client)
                .Include(o => o.OrdersDetails)
                .Include("OrdersDetails.Product");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientId,OrderDate")] Orders orders)
        {
            if (id != orders.Id)
            {
                return NotFound();
